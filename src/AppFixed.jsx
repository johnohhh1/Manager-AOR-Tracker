...
import BrandStandardsManual from './components/BrandStandardsManual';
    ...
    <Router>
      ...
      <Routes>
        ...
        <Route
          ...
          element={manager ? <BrandStandardsManual manager={manager} onBack={() => window.location.href = '/dashboard'} /> : <Navigate to="/" replace />}
        />
